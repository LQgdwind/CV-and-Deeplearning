...
class BasicBlock_gmp(nn.Module):
    expansion = 1

    def __init__(self, inplanes, planes, stride=1, downsample=None):
        super(BasicBlock_gmp, self).__init__()
...
class SENet_gmp(nn.Module):

    def __init__(self, block, layers, num_classes=1000):
        self.inplanes = 64
        super(SENet_gmp, self).__init__()
...
def se_resnet_18_gmp(**kwargs):
    model = SENet_gmp(BasicBlock_gmp, [2, 2, 2, 2], **kwargs)
    return model
